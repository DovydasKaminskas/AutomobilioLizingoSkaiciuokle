                            ...
                            <div class="col">
                                <div class="input-group" style="width:80%">
                                    <input type="number" class="form-control"
                                           ...
                                           max="{{$leasing->max_down_payment * $leasing->max_amount}}" id="down_payment"
                                           aria-labelledby="paymentLabel" data-min="{{ $leasing->min_down_payment }}"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <input type="range" class="form-range" value="{{$leasing->min_interest_rate * 100}}"
                                   ...
                                   max="{{$leasing->max_interest_rate * 100}}" step="0.01" id="interestRateSlider"
                                   aria-labelledby="interestLabel">
                            <div class="input-group" style="width:40%">
                                <input type="number" class="form-control" value="{{$leasing->min_interest_rate * 100}}"
                                       min="{{$leasing->min_interest_rate * 100}}"
