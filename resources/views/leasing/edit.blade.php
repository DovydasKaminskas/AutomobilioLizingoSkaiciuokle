                            ...
                            <div class="container">
                                <div class="row justify-content-md-center">
                                    <div class="mb-3 col-5">
                                        ...
                                        <div class="input-group col">
                                            <input type="number" class="form-control @error('min_amount') is-invalid @enderror" {{ $errors->has('min_amount') ? 'is-invalid' : '' }}" id="min_amount"
                                                   name="min_amount"
                                    ...
                                    <div class="mb-3 col-5">
                                        ...
                                        <div class="input-group col">
                                            <input type="number" class="form-control @error('max_amount') is-invalid @enderror" id="max_amount"
                                                   name="max_amount"
                                ...
                                <div class="row justify-content-md-center">
                                    <div class="mb-3 col-5">
                                        ...
                                        <div class="input-group col">
                                            <input type="number" class="form-control @error('min_down_payment') is-invalid @enderror" id="min_down_payment"
                                    ...
                                    <div class="mb-3 col-5">
                                        ...
                                        <div class="input-group col">
                                            <input type="number" class="form-control @error('max_down_payment') is-invalid @enderror" id="max_down_payment"
                                ...
                                <div class="row justify-content-md-center">
                                    <div class="mb-3 col-5">
                                        ...
                                        <div class="input-group col">
                                            <input type="number" class="form-control @error('min_time_period') is-invalid @enderror" id="min_time_period"
                                    ...
                                    <div class="mb-3 col-5">
                                        ...
                                        <div class="input-group col">
                                            <input type="number" class="form-control @error('max_time_period') is-invalid @enderror" id="max_time_period"
                                ...
                                <div class="row justify-content-md-center">
                                    <div class="mb-3 col-5">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control @error('min_interest_rate') is-invalid @enderror" id="min_interest_rate"
                                    ...
                                    <div class="mb-3 col-5">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control @error('max_interest_rate') is-invalid @enderror" id="max_interest_rate"
                                ...
                                <div class="row justify-content-md-center">
                                    <div class="mb-3 col-5 mx-auto">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control @error('administration_fee') is-invalid @enderror" id="administration_fee"
