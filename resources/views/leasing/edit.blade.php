                            ...
                            <div class="container">
                                ...
                                <div class="row justify-content-md-center">
                                    <div class="mb-3 col-5">
                                        ...
                                        <div class="input-group col">
                                            <input type="text" class="form-control" id="min_down_payment"
                                    ...
                                    <div class="mb-3 col-5">
                                        ...
                                        <div class="input-group col">
                                            <input type="text" class="form-control" id="max_down_payment"
                                ...
                                <div class="row justify-content-md-center">
                                    <div class="mb-3 col-5">
                                        ...
                                        <div class="input-group col">
                                            <input type="text" class="form-control" id="min_time_period"
                                    ...
                                    <div class="mb-3 col-5">
                                        ...
                                        <div class="input-group col">
                                            <input type="text" class="form-control" id="max_time_period"
                                ...
                                <div class="row justify-content-md-center">
                                    <div class="mb-3 col-5">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="min_interest_rate"
                                    ...
                                    <div class="mb-3 col-5">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="max_interest_rate"
                                ...
                                <div class="row justify-content-md-center">
                                    <div class="mb-3 col-10">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="administration_fee"
